 ...
 *Time: 2020/11/25
 */
abstract class BaseBannerAdapter<T : Any> : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        (holder as? BaseBannerAdapter<out Any>.ViewHolder)?.onBindViewHolder(position)
    }
    ...
    override fun onBindViewHolder(
        ...
        if (payloads.isEmpty()) {
            ...
            val viewHolder = holder as? BaseBannerAdapter<*>.ViewHolder
    ...
    private val diffCallback = object : DiffUtil.ItemCallback<T>() {
        ...
        override fun areItemsTheSame(oldItem: T, newItem: T): Boolean {
            return this@BaseBannerAdapter.areItemsTheSame(oldItem, newItem)
        }

        override fun areContentsTheSame(oldItem: T, newItem: T): Boolean {
            return this@BaseBannerAdapter.areContentsTheSame(oldItem, newItem)
        }
    }
    ...
    inner class ViewHolder internal constructor(parent: ViewGroup, layout: Int) :
        ...
        init {
            ...
            itemHelper.setRVAdapter(this@BaseBannerAdapter)
        ...
        override fun onClick(v: View) {
            if (::mOnItemClickListener.isInitialized) {
                mOnItemClickListener(this@BaseBannerAdapter, v, mPosition)
            }
        }

        override fun onLongClick(v: View): Boolean {
            if (::mOnItemLongClickListener.isInitialized) {
                mOnItemLongClickListener(this@BaseBannerAdapter, v, mPosition)
                return true
            }
            return false
        }
    ...
    private fun loadMore(position: Int) {
        if (::mOnLoadMoreListener.isInitialized &&
            ...
            mLoadMoreCount = itemCount
            mOnLoadMoreListener(this@BaseBannerAdapter, itemCount - 1)
        }
    }

    class ItemHelper(private val viewHolder: BaseBannerAdapter<out Any>.ViewHolder) :
        View.OnClickListener {
        private val viewCache = SparseArray<View>()
        private val clickListenerCache = ArrayList<Int>()
        private val mTags = HashMap<String, Any>()
        lateinit var adapter: BaseBannerAdapter<out Any>
            private set
        @LayoutRes
        @get:LayoutRes
        ...
        private lateinit var mOnItemChildClickListener:
                    (adapter: BaseBannerAdapter<out Any>, v: View, position: Int) -> Unit
        ...
        fun setRVAdapter(RVAdapter: BaseBannerAdapter<out Any>) {
            adapter = RVAdapter
        }
    ...
    private lateinit var mOnLoadMoreListener:
                (adapter: BaseBannerAdapter<out Any>, lastItemPosition: Int) -> Unit
