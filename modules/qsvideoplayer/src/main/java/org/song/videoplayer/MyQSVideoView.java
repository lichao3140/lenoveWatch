...
import cn.ycgo.base.medial.view.dialog.NormalDialog;
 ...
 */
public class MyQSVideoView extends QSVideoViewHelp {
    ...
    public MyQSVideoView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);

    }

    public MyQSVideoView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected boolean showWifiDialog() {
        ...
        new NormalDialog()
                .setSubTitle(getResources().getString(R.string.tips_not_wifi))
                .setAffirmText(getResources().getString(R.string.tips_not_wifi_confirm))
                .setCancelText(getResources().getString(R.string.tips_not_wifi_cancel))
                .setAffirmListener(new Function1<View, Boolean>() {
                    @Override
