...
public class QSVideoView extends FrameLayout implements IVideoPlayer, IMediaCallback {
    ...
    private void init(Context context) {
        ...
        iMediaControl = ConfigManage.getInstance(getContext()).getMediaControl(this, IjkExoMedia.class);
        ...
        renderViewContainer.setBackgroundColor(Color.TRANSPARENT);
    ...
    protected void prepareMediaPlayer() {
        ...
        if (openCache && urlMode == 0) {
            String cacheUrl =CacheManager.buildCahchUrl(getContext(), url, headers);
